...
@Embeddable
public class DsrDwId implements java.io.Serializable{
    ...
    /** full constructor */
    public DsrDwId(Integer ajxh, Integer dsrbh) {
        this.ajxh = ajxh;
        this.dsrbh = dsrbh;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof DsrDwId))
            return false;
        DsrDwId castOther = (DsrDwId) other;

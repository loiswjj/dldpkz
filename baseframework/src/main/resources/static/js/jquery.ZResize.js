(function($) {
    ...
    ZResize.prototype = {
        ...
        bindResizeEvent: function(el) {
            ...
            var percent = self.options.percent/100
            //东
            var emove = false;
            ...
            $(self.options.stage).on('mousemove', function(e) {
                if(emove) {
                    ...
                    form.find('#width').val(Math.ceil((ow + x)*percent))
                } else if(smove) {
                    var y = (e.pageY - oy);
                    el.css({
                        height: oh + y
                    ...
                    form.find('#height').val(Math.ceil((oh + y)*percent))
                } else if(wmove) {
                    var x = (e.pageX - ox);
                    el.css({
                        width: ow - x,
                    ...
                    form.find('#pos_x').val(Math.ceil((oleft + x)*percent))
                    form.find('#width').val(Math.ceil((ow - x)*percent))
                } else if(nmove) {
                    var y = (e.pageY - oy);
                    el.css({
                    ...
                    form.find('#pos_y').val(Math.ceil((otop + y)*percent))
                    form.find('#height').val(Math.ceil((oh - y)*percent))
                } else if(nemove) {
                    var x = e.pageX - ox;
                    var y = e.pageY - oy;
